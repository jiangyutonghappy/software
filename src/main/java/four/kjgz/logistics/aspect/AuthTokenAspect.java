...
import four.kjgz.logistics.contorll.AuthToken;
...
public class AuthTokenAspect {
    ...
    public Object deBefore(ProceedingJoinPoint pjp, AuthToken authToken) throws Throwable {
        ...
        System.out.println(role_name[0]);
        System.out.println(role_name[0] == "未用");
        if (role_name[0].equals("未用")||role_name == null || role_name.length == 0) {
            // 只需登录，验证是否具有id即可。
